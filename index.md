...
![Giao diện ban đầu](https://tp-archived.github.io/LearningToeicLC/assets/img/guide/1_openApp.png)

Sau đó, tiến hành tạo project cho lần khởi chạy đầu tiên và mở một project đã có sẵn cho lần những lần sau
![Tạo hoặc mở project](https://tp-archived.github.io/LearningToeicLC/assets/img/guide/2_create%20Project.png)

Bước tiếp theo, như những trình chơi nhạc bình thường. Hãy chọn file nghe mp3 toeic mà bạn đang cần luyện tập:
![Mở file mp3](https://tp-archived.github.io/LearningToeicLC/assets/img/guide/3_Open%20media%20file.png)
![Chạy file mp3 như bình thường](https://tp-archived.github.io/LearningToeicLC/assets/img/guide/4_running%20like%20any%20mp3%20file%20player.png)
...
![Đánh dấu session](https://tp-archived.github.io/LearningToeicLC/assets/img/guide/5_save%20session.png)

Sau khi hoàn thành bài nghe, bạn đã có một list các session. Lựa chọn từng session và tiến hành nghe cho thật kỹ
![Nghe session](https://tp-archived.github.io/LearningToeicLC/assets/img/guide/6_%20Replay%20session.png)
